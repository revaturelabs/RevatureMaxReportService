...
class TestSelfComparison(TestCase):
    ...
    def test_batch_averages_by_week(self, m_fetch):
        with open("src/test/route/caliber_data/reports_TR-1190_spider.json") as spider_json:
    ...
    def test_score_report_by_week(self, m_fetch):
        with open("src/test/route/caliber_data/reports_TR-1190_spider_mock8.json") as spider_json:
            m_fetch.return_value = loads(spider_json.read())
